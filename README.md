...
```
(venv) ubuntu@server-1:~/ansible$ python -m ansible.modules.my_own_module my_module.json
...
```
(venv) ubuntu@server-1:~/ansible$ ansible-playbook site.yml
...
```
ubuntu@server-1:~/my_own_collection/my_own_namespace/yandex_cloud_elk$ ansible-galaxy collection build
Created collection for my_own_namespace.yandex_cloud_elk at /home/ubuntu/my_own_collection/my_own_namespace/yandex_cloud_elk/my_own_namespace-yandex_cloud_elk-1.0.0.tar.gz
ubuntu@server-1:~/my_own_collection/my_own_namespace/yandex_cloud_elk$
